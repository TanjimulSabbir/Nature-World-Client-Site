...
const Banner04 = () => {
    return (
        <div className='UniversalPadding py-24'>
            <div className='md:flex md:justify-center md:items-center md:space-x-12'>
                <img className='w-full md:w-5/12' src="https://templatekits.techeshta.com/nature-world/wp-content/uploads/sites/21/2023/01/about-nature-world-1525x1536.png" alt="" />
                ...
                <div className='w-full md:w-7/12 mt-14 md:mt-0'>
                    ...
                    <Link to="/about" className='Btn-Primary mt-8'>Read More <HiArrowSmRight className='ml-1 text-xl' /> </Link>
                </div>
            </div>
        </div>
    );
